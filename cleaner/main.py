...
if __name__ == "__main__":
    ...
    for file in filenames:
        ...
        cleaner.compute_restaurant_tfidf()

        cleaner.save_tokenized_corpus('./cleaned_data/')
        cleaner.save_files('./cleaned_data/restaurant_wordclouds/', 'wordclouds', save_wordcloud, './capgemini.jpg')
        cleaner.save_files('./cleaned_data/restaurant_word_frequencies','tfidf', save_tfidf, './capgemini.jpg')